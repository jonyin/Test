	...
	private static void duoTuWen(List<Sucai> sucaiList) {
		...
		for (int i = 1; i <= sucaiList.size(); i++) {
			...
			driver.findElement(
					...
					.sendKeys("http://www.jintengjichuang.cn/heka/9393.html");
			driver.findElement(
		...
		driver.findElement(By.xpath("//span[@id='js_submit']/button")).click();
	}
