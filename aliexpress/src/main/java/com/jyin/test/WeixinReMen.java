...
public class WeixinReMen {
	...
	private static String FILE_DIR = "c:\\weixin\\sucai\\remen\\";
...
//		List<String> sucaiUrlList = readFileByLines(FILE_DIR+"url.txt");
		List<String> sucaiUrlList = readUrlsByURL(readFileByLines(FILE_DIR+"url.txt").get(0));
	...
	private static List<String> readUrlsByURL(String historyUrl) {
//		historyUrl = "http://weixin.sogou.com/gzh?openid=oIWsFt6c3lq6YHN_2PfR1EI6z1Qc";
		driver.get(historyUrl+"");
		List<WebElement> linkElements = driver.findElements(By.xpath("//div[@class='wx-img-box']/a"));
	...
	private static void duoTuWen(List<Sucai> sucaiList) {
		...
		waitForPageLoad();
		driver.findElement(By.xpath("//span[@class='create_access jsCreate']"))
				.click();
		...
		WebElement addElement = driver.findElement(By
				.xpath("//a[@class='create_access_primary appmsg_add']"));
		for (int i = 2; i < sucaiList.size(); i++) {
			addElement.click();
		}
		for (int i = 1; i <= sucaiList.size(); i++) {
				...
				editMaskElement = driver
						.findElement(By
								.xpath("//div[@id='appmsgItem"
										+ i
										+ "']/div[@class='cover_appmsg_item']/div[@class='appmsg_edit_mask']"));
			} else {
			...
			driver.findElement(
					...
					.sendKeys("http://mp.weixin.qq.com/s?__biz=MjM5NDk4MzYzNw==&mid=204075030&idx=1&sn=cfe84847abdb1d4348b351d9de78d52a#rd");
			driver.findElement(
			...
			try {
				String endContent = "<p style=\"margin-top: 10px; margin-bottom: 0px; font-size: 15.5555562973022px; padding: 0px; max-width: 100%; word-wrap: break-word; min-height: 1.5em; white-space: pre-wrap; overflow: hidden; text-align: center; line-height: 28px; font-family: 微软雅黑; color: rgb(255, 255, 0); word-break: normal; text-shadow: rgb(69, 117, 58) 0px 1px 1px; border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; background-color: rgb(0, 0, 0); box-sizing: border-box !important;\"><img width=\"30px\" height=\"24\" data-w=\"31\" data-ratio=\"0.7741935483870968\" data-src=\"http://mmbiz.qpic.cn/mmbiz/s9GQle8DWLE3r386XiaJHm1V4FlkHn5GwsWWC8Fz4JXB59jbZdxibDxfl4Yco1YL9QIEbC5OPcFmMKP0A0wQyA4A/0\" style=\"margin: 0px; padding: 0px; white-space: normal; float: left; box-sizing: border-box !important; word-wrap: break-word !important; width: 30px !important; visibility: visible !important; height: auto !important;\" _width=\"30px\" src=\"http://mmbiz.qpic.cn/mmbiz/s9GQle8DWLE3r386XiaJHm1V4FlkHn5GwsWWC8Fz4JXB59jbZdxibDxfl4Yco1YL9QIEbC5OPcFmMKP0A0wQyA4A/0?tp=webp&amp;wxfrom=5\"><span style=\"margin: 0px; padding: 0px; max-width: 100%; color: rgb(255, 255, 255); font-size: 14px; box-sizing: border-box !important; word-wrap: break-word !important;\"><img width=\"30px\" height=\"24\" data-w=\"29\" data-ratio=\"0.8275862068965517\" data-src=\"http://mmbiz.qpic.cn/mmbiz/s9GQle8DWLE3r386XiaJHm1V4FlkHn5GwsWWC8Fz4JXB59jbZdxibDxfl4Yco1YL9QIEbC5OPcFmMKP0A0wQyA4A/0\" style=\"margin: 0px; padding: 0px; white-space: normal; float: left; box-sizing: border-box !important; word-wrap: break-word !important; width: 30px !important; visibility: visible !important; height: auto !important;\" _width=\"30px\" src=\"http://mmbiz.qpic.cn/mmbiz/s9GQle8DWLE3r386XiaJHm1V4FlkHn5GwsWWC8Fz4JXB59jbZdxibDxfl4Yco1YL9QIEbC5OPcFmMKP0A0wQyA4A/0?tp=webp&amp;wxfrom=5\"><span style=\"margin: 0px; padding: 0px; max-width: 100%; font-size: 14px; box-sizing: border-box !important; word-wrap: break-word !important;\">猛戳“阅读原文”查看更多热门图文</span></span></p>";
				((JavascriptExecutor) driver)
						.executeScript("document.getElementById('ueditor_0').contentDocument.getElementsByClassName('view')[0].innerHTML   = '"
								+ startContent
								+sucaiList.get(i - 1).content
								+ endContent
								+ "';");
			} catch (Exception e) {
				// TODO Auto-generated catch block
